...
into emotions like happiness, sadness, anger, and surprise. Models capable of
detecting human emotions would enable use cases such as virtual assistants
...
Before feeding this data, the plan is to apply data preprocessing techniques like 
removing background noise and converting the audio to visual spectrograms. Furthermore,
a dynamic learning rate scheduler will be implemented. This essentially allows 
