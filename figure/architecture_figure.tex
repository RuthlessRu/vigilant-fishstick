...
\node[canvas is zy plane at x=0] (temp) at (-3,0,0){\includegraphics[width=8cm,height=8cm]{../resources/soundimage.jpg}};
% conv1_1,conv1_2
...
%%%%%%%%%%
% conv3_1,conv3_2
\pic[shift={(-5,-13,0)}] at (p1-east) {RightBandedBox={name=cr3,caption=conv2D 2,%
        fill=\ConvColor,bandfill=\ConvReluColor,%
        height=30,width={4,4,4},depth=30}};
\pic[shift={(-2.8,-13,0)}] at (p1-east)  {RightBandedBox={name=bn1,%
        fill=\BNColor,%
        height=30,width={1},depth=30}};
\pic[shift={(-2.6,-13,0)}] at (p1-east)  {RightBandedBox={name=bn1,%
        fill=\DropColor,%
        height=30,width={1},depth=30}};
...
\pic[shift={(2.8,0,0)}] at (p3-east) {RightBandedBox={name=cr4,caption=conv2D 3,%
        fill=\ConvColor,bandfill=\ConvReluColor,%
        height=23,width={7,7,7},depth=23}};
\pic[shift={(7,0,0)}] at (p3-east) {RightBandedBox={name=bn3,%
        fill=\BNColor,
        height=23,width={1},depth=23}};
\pic[shift={(7.2,0,0)}] at (p3-east) {RightBandedBox={name=dp3,%
        fill=\DropColor,
        height=23,width={1},depth=23}};
%pool4
...
\pic[shift={(3,0,0)}] at (denselayer-east) {Box={name=softmax,%
        fill=\SoftmaxColor,%
        height=10,width=1,depth=1,caption=Softmax-Output}};
...
\draw [connection]  (cnnbox-west)    -- node {\midarrow} (cr3-north);
...
\draw [connection]  (denselayer-east)    -- node {\midarrow} (softmax-west);
